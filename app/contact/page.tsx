...
export default function ContactPage() {
  return (
    <div style={{ background: "#fff" }}>
      ...
      {/* Header */}
      <section style={{ background: "linear-gradient(135deg, #2c6300 0%, #377A00 60%, #4a9900 100%)", padding: "3rem 0 2.5rem" }}>
        <div className="container" style={{ textAlign: "center" }}>
          <p style={{ color: "rgba(255,255,255,0.85)", fontWeight: 600, fontSize: ".8125rem", letterSpacing: ".16em", textTransform: "uppercase", marginBottom: ".5rem" }}>
            Get in Touch
          </p>
          <h1 style={{ fontFamily: "var(--font-heading), serif", fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 700, color: "#fff", marginBottom: ".75rem" }}>
            Contact
          </h1>
          <p style={{ color: "rgba(255,255,255,.8)", fontSize: "1.0625rem", maxWidth: "480px", margin: "0 auto" }}>
