...
const products = [
  {
    ...
    details: ["25 YES/NO questions across 5 dimensions", "Section-by-section breakdown", "4-tier self-discovery activation result", "Optional consultation with Andrew"],
  ...
  },
  {
    ...
    details: ["35 questions across 7 dimensions", "Radar chart & competitor archetype", "Personalised feedback per dimension", "Optional consultation with Andrew"],
