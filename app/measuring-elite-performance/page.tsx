...
export const metadata: Metadata = {
  ...
  description:
    "Why standard assessments fail advanced athletes — and how the Elite Tennis Profile (ETP) provides a more precise instrument for a more precise mind.",
};
    ...
    <>
      ...
      <div style={{ background: "#fff" }}>
        <article style={{
          ...
          <p style={styles.body}>
            The <strong>Elite Tennis Profile (ETP)</strong> is a percentage-based
          ...
          <blockquote style={{ ...styles.pullQuote, paddingTop: "1.5rem", paddingBottom: "1.5rem" }}>
            ...
            The ETP is not designed to define you. It is a precise, dynamic
